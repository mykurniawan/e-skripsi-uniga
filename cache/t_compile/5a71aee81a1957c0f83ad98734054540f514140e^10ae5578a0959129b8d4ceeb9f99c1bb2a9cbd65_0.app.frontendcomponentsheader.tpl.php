...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_69081f048a0230_45020671',
...
function content_69081f048a0230_45020671 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php if ($_smarty_tpl->tpl_vars['requestedPage']->value !== 'login' && $_smarty_tpl->tpl_vars['requestedPage']->value !== 'user') {?>
	...
	<header class="sticky top-0 z-50 flex flex-none flex-wrap items-center justify-between bg-white px-4 py-5 shadow-md shadow-slate-900/5 transition duration-500 sm:px-6 lg:px-8 dark:shadow-none dark:bg-slate-900/95 dark:backdrop-blur dark:[@supports(backdrop-filter:blur(0))]:bg-slate-900/75">
		...
		<?php $_block_plugin4 = isset($_smarty_tpl->smarty->registered_plugins['block']['material_sidestack'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['material_sidestack'][0][0] : null;
if (!is_callable(array($_block_plugin4, 'smartyMaterialSidestack'))) {
...
$_block_repeat=true;
echo $_block_plugin4->smartyMaterialSidestack(array('class'=>"flex xl:hidden"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			<div class="space-y-9">
...
echo $_block_plugin4->smartyMaterialSidestack(array('class'=>"flex xl:hidden"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
